 ...
 */
    ...
    public void postMethod1(){
        ...
        Response response = given().accept(ContentType.JSON).and() //what we are asking for api which is JSON response
    ...
    requestJsonMap.put("name","VivienLee");
    requestJsonMap.put("gender","Female");
    requestJsonMap.put("phone",46575766767L);
